...
public class RocksDBManager extends DBManager {
    ...
    public void list() throws Exception {
        String crawldbPath = crawlPath + "/crawldb";
    ...
    public void merge() throws Exception {
         LogUtils.i("start merge");
        RocksDB crawldbDatabase = RocksDBUtils.openCrawldbDatabase(crawlPath);


        /*合并fetch库*/
         LogUtils.i("merge fetch database");
        ...
        /*合并link库*/
         LogUtils.i("merge link database");
